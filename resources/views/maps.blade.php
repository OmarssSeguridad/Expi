...
if (isset($_GET['find'])) {
    ...
    // Webservices
    $google_maps_url   = "https://maps.googleapis.com/maps/api/geocode/json?address=1600+Amphitheatre+Parkway,+Mountain+View,+CA&key=" . $api_key;
...
<head>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB8pv5I_mAFds4GStju2XWwkGOnrOFRfGk" ></script>
    <style>
        #map{
            width: 100%;
            height: 400px;
